 ...
 * Clusters app routes.
 */
app.get('/clusters', passportConf.isAuthenticated, clustersController.getIndex);
app.post('/clusters', passportConf.isAuthenticated, clustersController.postIndex);
app.get('/clusters/new', passportConf.isAuthenticated, clustersController.getCreate);
