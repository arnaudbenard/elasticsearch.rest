...
module.exports = {
  ...
  db: process.env.MONGOLAB_URI ? process.env.MONGOLAB_URI + '/production' : 'mongodb://localhost:27017/test',
  ...
  github: {
    clientID: process.env.GITHUB_ID || '410a08dcdffd10b7bae6',
    clientSecret: process.env.GITHUB_SECRET || '3c94171774d004758f41ba99a64aa16849783ed8',
